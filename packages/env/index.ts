...
const server: Parameters<typeof createEnv>[0]['server'] = {
  ...
  EVEN3_WEBHOOK_SECRET: z.string().min(1).startsWith('whsec_'),
  EVEN3_AUTHORIZATION_APP: z.string().min(1),
  EVEN3_TOKEN: z.string().min(1),
...
export const env = createEnv({
  ...
  runtimeEnv: {
    ...
    EVEN3_WEBHOOK_SECRET: process.env.EVEN3_WEBHOOK_SECRET,
    EVEN3_AUTHORIZATION_APP: process.env.EVEN3_AUTHORIZATION_APP,
    EVEN3_TOKEN: process.env.EVEN3_TOKEN,
